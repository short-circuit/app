...
discordClient.on("message", (message) => {
  ...
  if (
    ...
    message.member.roles.cache.some((role) =>
      allowedAdminRoles.includes(role.name)
    )
  ) {
    ...
    if (message.content === "!playerlist" && message.channel.name === "test") {
      //conanserver
      conanRcon.send("");
    ...
    if (message.content === "!rcon_help" && message.channel.name === "test") {
      //conanserver
      conanRcon.send("help");
      console.log("request sent to rcon");
    }
    ...
    if (
      message.content === "!rcon_disconnect" &&
      message.channel.name === "test"
    ) {
      //conanserver
    ...
    if (
      message.content.includes("!broadcast ") &&
      message.channel.name === "test"
    ) {
      //conanserver
    ...
    if (message.content.includes("!rcon")) lastcommand = message.content;
  }
});
